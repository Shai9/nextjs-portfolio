...
import prj2 from '../public/assets/project2.png';
    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Quizzy UI</h2>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            vanilla CSS and some Javascript. The application is hosted statically using Vercel.A
            few features to note with this project are the consumption of an external api and also the responsiveness of the app.
          </p>
          <a
            href='https://kuizzy-shai9.vercel.app/'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://github.com/Shai9/kuizzy/'
            target='_blank'
            rel='noreferrer'
          >
